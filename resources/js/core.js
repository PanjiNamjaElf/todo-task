  ...
  function ($) {
    ...
    App.prototype.initControls = function () {
      ...
      $('[data-toggle="fullscreen"]').on('click', function (e) {
        ...
        if (!document.fullscreenElement && /* alternative standard method */ !document.mozFullScreenElement &&
      ...
      App.prototype.init = function () {
        ...
        if (window.sessionStorage && bodyConfig && bodyConfig.hasOwnProperty('showRightSidebarOnPageLoad') &&
